...
config = dict(
    workdir=f"/storage2/datasets/nkeetha/4d/experiments/{group_name}",
    run_name=run_name,
    seed=seed,
    ...
    data=dict(
        ...
        gradslam_data_cfg=f"/storage2/datasets/nkeetha/4d/4DTrack/configs/data/TUM/{scene_name}.yaml",
