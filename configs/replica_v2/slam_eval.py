...
group_name = "SLAM_Replica_V2_NVS"
run_name = f"{scene_name}_{seed}"

config = dict(
    scene_path=f"./results/SLAM_Replica_V2/{scene_name}_{seed}/params.npz",
    workdir=f"./results/{group_name}",
    run_name=run_name,
    seed=seed,
    ...
    data=dict(
        basedir="/home/airlab/nkeetha/4d/data/Replica_V2",
        gradslam_data_cfg="/home/airlab/nkeetha/4d/4DTrack/configs/data/replica_v2.yaml",
        sequence=scene_name,
